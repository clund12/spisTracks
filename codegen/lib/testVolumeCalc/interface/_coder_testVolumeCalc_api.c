 ...
 * File: _coder_testVolumeCalc_api.c
 *
...
#include "_coder_testVolumeCalc_mex.h"
 ...
 * Return Type  : void
 */
void testVolumeCalc_api(const mxArray * const prhs[2], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*D)[6];
  real_T R;
 ...
 * Return Type  : void
 */
void testVolumeCalc_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void testVolumeCalc_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void testVolumeCalc_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_testVolumeCalc_api.c
 *
 * [EOF]
 */
