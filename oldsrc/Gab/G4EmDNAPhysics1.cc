...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmDNAPhysics1);


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmDNAPhysics1::G4EmDNAPhysics1(G4int ver)
  : G4VPhysicsConstructor("G4EmDNAPhysics1"), verbose(ver)
{
...
G4EmDNAPhysics1::G4EmDNAPhysics1(G4int ver, const G4String&)
  : G4VPhysicsConstructor("G4EmDNAPhysics1"), verbose(ver)
{
  SetPhysicsType(bElectromagnetic);
}
...
G4EmDNAPhysics1::~G4EmDNAPhysics1()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmDNAPhysics1::ConstructParticle()
{
// bosons
  G4Gamma::Gamma();
...
void G4EmDNAPhysics1::ConstructProcess()
{
  if(verbose > 1) {
  ...
  while( (*aParticleIterator)() )
  {
    ...
    if (particleName == "e-") {
      ...
      eIoni->SetMinKinEnergy(1*MeV); // Looks like a repeat?
      ph->RegisterProcess(eIoni, particle);


      // G4StepLimiter* stepLim = new G4StepLimiter();
      // // stepLim->SetMinKinEnergy(1*MeV); 
      //  ph->RegisterProcess(stepLim, particle);
